...
cp .env.example .env               # then paste your real Gemini key (get one free at aistudio.google.com) into .env
...
| `/chat` | POST | AI Health Assistant (Gemini-backed) |
| `/symptom-checker` | POST | Structured symptom flow (Gemini-backed) |

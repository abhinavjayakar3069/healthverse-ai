...
## Phase 4 — AI Assistant + Symptom Checker (5 min, needs Gemini key set)
...
## Phase 5 — Photo features (5 min, needs Gemini key + camera)
...
not running, Gemini key not set/invalid, a permission denied on the phone.
